...
console.log(oddCalc / oddValues.length);
...
const oddsKeyValues = [...Object.entries(game.odds)];
for (const [key, value] of oddsKeyValues) {
    console.log(`Odd of ${key !== `x` ? `victory ${game[key]}` : `draw`}: ${value}`);
}
