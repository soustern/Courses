...
// We cant have the following solution here:

// const [booksAuthors] = [...books[0].author, ...books[1].author];
// This would mean the following: a new array containing the values resulted from the deconstruction of two arrays 
// would be returned. the receiver. being [bookAuthors], would iterate the returning array (am implications of using [])
// meaning it would only access the index 0 of the received array, storing in itself only the first name
// present in the array. if we only use const bookAuthors = ... then we are actually receiving the array in itself
// Not iterating it to collect a specific value within
