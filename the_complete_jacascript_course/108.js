...
// Array destructuring (unpacking it into variables)
const [x, y, z] = arr;
// console.log(x, y, z);

// Skipping one position in a array when destructuring
let [main, secondary, , forth] = restaurant.categories;
// console.log(main, secondary, forth);
...
// Example of destructuring with default values assigned to the variables
